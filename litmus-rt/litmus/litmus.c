...
static int do_plugin_switch(void *_plugin)
{
	...
	int ret = 0;
	//hacked by zhe
	printk("[zhe]: @litmus-rt/litmus/litmus.c do_plugin_switch is called\n");
...
int switch_sched_plugin(struct sched_plugin* plugin)
{
	...
	//hacked by zhe
	printk("[zhe]: @litmus-rt/litmus/litmus.c switch_sched_plugin is called\n");
	...
	if (atomic_read(&rt_task_count) == 0) {
		...
		//hacked by zhe
		printk("[zhe]: @litmus-rt/litmus/litmus.c get_domain_proc_info will be called\n");
