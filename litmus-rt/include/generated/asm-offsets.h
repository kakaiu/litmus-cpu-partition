...
#define PV_CPU_usergs_sysret64 256 /* offsetof(struct pv_cpu_ops, usergs_sysret64)	# */
...
#define TASK_threadsp 4960 /* offsetof(struct task_struct, thread.sp)	# */
#define TASK_stack_canary 2144 /* offsetof(struct task_struct, stack_canary)	# */

#define TASK_TI_flags 0 /* offsetof(struct task_struct, thread_info.flags)	# */
#define TASK_addr_limit 5096 /* offsetof(struct task_struct, thread.addr_limit)	# */
